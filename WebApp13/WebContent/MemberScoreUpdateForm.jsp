...
<%
	...
	// sid 를 제외한 나머지 속성값을 조회하기 위해 dao 인스턴스 생성
...
<div>
	<h1>회원 성적 관리<span style="font-size: 10pt; color: blue;">수정 페이지</span></h1>
	<hr />
</div>
	...
	<form action="MemberScoreUpdate.jsp?sid=<%=sid %>" method="post" id="memberScoreForm">
		<table class="table">
			...
			<tr>
				...
				<td>
					<span class="errMsg" id="korMsg">0 ~ 100점 사이의 정수를 입력해야 합니다.</span>
				</td>
			</tr>
			<tr>
				<th>영어점수</th>
				...
				<td>
					<span class="errMsg" id="engMsg">0 ~ 100점 사이의 정수를 입력해야 합니다.</span>
				</td>
			</tr>
			<tr>
				<th>수학점수</th>
				...
				<td>
					<span class="errMsg" id="matMsg">0 ~ 100점 사이의 정수를 입력해야 합니다.</span>
				</td>
			</tr>
		</table>
		<br>
